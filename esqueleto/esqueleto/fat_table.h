...
u32 fat_table_get_next_free_cluster(fat_table table);   //---->USARR
...
/*Funciona muy parecido a fat_table_get_next_cluster solo que si es necesario y posible, crea un nuevo cluster.*/
u32 fat_table_newxt_cluster(fat_table table, u32 cur_cluster);
